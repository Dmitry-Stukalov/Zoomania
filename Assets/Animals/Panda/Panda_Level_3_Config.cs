...
namespace Animal
{
    [CreateAssetMenu(fileName = nameof(Panda_Level_3_Config), menuName = "Animals/Panda" + nameof(Panda_Level_3_Config))]
    public class Panda_Level_3_Config : ScriptableObject
    {
