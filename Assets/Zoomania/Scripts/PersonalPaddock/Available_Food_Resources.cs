...
public class Available_Food_Resources : MonoBehaviour
{
	...
	public void Initialize()
	{
		if (!start)
		{
			CurrentResources = GameObject.FindGameObjectWithTag("Background").GetComponent<FoodCountBuffer>().FoodBuildingScript;
