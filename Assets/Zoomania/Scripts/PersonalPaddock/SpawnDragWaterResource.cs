...
public class SpawnDragWaterResource : MonoBehaviour//, IPointerClickHandler
{
	...
	private AvailableWaterResource availableResources { get; set; }
	...
	public void OnPointerClick(PointerEventData eventData)
	{
		...
		if (availableResources.WaterTimer.IncomeResources.Resource > 0)
		{
			...
			resource.GetComponent<WaterResource>().FindAllPoints(AnimalPlace.transform.position, Speed);
			resource.GetComponent<WaterResource>().IsMove = true;
