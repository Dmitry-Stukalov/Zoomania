...
public class Buy_Food_Button : MonoBehaviour, IPointerClickHandler
{
	...
	public void Start()
	{
		...
		WaterBuilding = GameObject.FindGameObjectWithTag("FoodBuilding").GetComponent<ResourceBuilding>();
